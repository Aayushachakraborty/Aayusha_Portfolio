...
export default function MMMProject() {
  ...
  return (
    <div style={{
      ...
      {/* Top bar */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: `1px solid ${T.rule}`, background: T.paper }}>
      ...
      <div style={{ display: 'flex', maxWidth: 1480, margin: '0 auto' }}>
        {/* Sidebar */}
        <nav style={{ width: 240, padding: '28px 0 28px 28px', borderRight: `1px solid ${T.rule}`, position: 'sticky', top: 0, alignSelf: 'flex-start', minHeight: 'calc(100vh - 60px)' }}>
          <div style={{ fontSize: 10, color: T.ink3, letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 700, marginBottom: 14, paddingLeft: 8 }}>Project Sections</div>
          {PAGES.map((p, i) => {
            const Icon = p.icon;
          ...
          <div style={{ marginTop: 28, padding: '14px 14px', background: T.paper2, marginRight: 20, fontSize: 11, lineHeight: 1.5, color: T.ink2 }}>
        ...
        {/* Content */}
        <main style={{ flex: 1, padding: '32px 44px 80px', minWidth: 0 }}>
